...
import { getDistrictAnomalies } from "@/lib/api"
...
export default function DistrictAnomalyAlerts({ districtName = "Mumbai" }) {
  ...
  const loadAnomalies = async () => {
    try {
      setLoading(true)
      const data = await getDistrictAnomalies(districtName)
      setAnomalies(data)
    } catch (error) {
            ...
            >
              ...
              <div className="mb-3">
                ...
                <div className="flex items-center space-x-4 text-xs text-gray-600">
                  ...
                  {!anomaly.scheme_name && anomaly.scheme_code && (
                    <span>Scheme: {anomaly.scheme_code}</span>
                  )}
                </div>
              </div>
